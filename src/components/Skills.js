  ...
  return (
    <div className="p-8">
      ...
      <div className="flex justify-between">
        <div className="w-1/2">
          <p className="font-bold">Me and My Tech Stack</p>
          <p>
            Hi Everyone, My name is Lalit Kumar. I am a Front-end Web Developer
            and have been working for the last 6 months. Currently, I am a
            student in my 1st year.
          </p>
          <p>
            ...
            someone who is enthusiastic about web development. Together, we can
            bring your project to life with cutting-edge technologies,
            ...
            user interface, I'm confident in my abilities to deliver exceptional
            results. Let's work together and create something truly remarkable
